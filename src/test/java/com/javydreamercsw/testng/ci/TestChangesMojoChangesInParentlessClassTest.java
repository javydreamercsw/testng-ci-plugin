...
@Slf4j
public class TestChangesMojoChangesInParentlessClassTest extends TestChangesMojoTest {
  ...
  public void testTestChangesGoal() throws Exception {
    // Modify a file.
    File modifiedFile = new File(projectRoot, "src/test/java/basic/project/ParentlessTest.java");
    ...
    instance
        ...
        .forEach(
            c ->
                sa.assertThat(c.getSimpleName())
                    .describedAs(
                        String.format(
                            "Expected %s to be %s!", c.getSimpleName(), "ParentClassTest"))
                    .isEqualTo("ParentlessTest"));
